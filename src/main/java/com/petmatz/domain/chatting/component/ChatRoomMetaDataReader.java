...
public class ChatRoomMetaDataReader {
    ...
    public Map<String, ChatRoomMetaDataInfo> findChatRoomMetaDataInfo(List<String> chatRoomNumbers, Map<String, Integer> unreadCountList, Map<String, IChatUserInfo> userList) {
        ...
        return mongoTemplate.find(query, ChatRoomMetadataDocs.class).stream()
                .collect(Collectors.toMap(
                        ChatRoomMetadataDocs::getRoom_id,
                        chatRoomMetadataDocs -> {
